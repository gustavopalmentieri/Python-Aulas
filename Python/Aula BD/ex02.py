...
cursor = banco.cursor()
cursor.execute("CREATE TABLE IF NOT EXISTS funcionarios(nome text, idade integer, email text)") #"IF NOT EXISTS" - CRIE A TABELA SE NÃO EXISTIR A TABELA É A MESMO COISA DE COMENTAR IGUAL AOS OUTROS ARQUIVOS
